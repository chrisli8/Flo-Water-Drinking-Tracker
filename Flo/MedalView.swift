...
class MedalView: UIImageView {
    ...
    */
    ...
    func createMedalImage() -> UIImage {
        ...
        //Create a transform
        //Scalte it, and translate it right and down
        ...
        //Must be NSSting to be able to use draw(in: )
        ...
        //this code should be at the end of the playground
